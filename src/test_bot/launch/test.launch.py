...
from launch import LaunchDescription ##OBRIGATÓRIO
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription
from launch.substitutions import LaunchConfiguration, Command
from launch.launch_description_sources import PythonLaunchDescriptionSource

from launch_ros.actions import Node ##OBRIGATÓRIO
...
def generate_launch_description():  ##OBRIGATÓRIO
    use_sim_time = LaunchConfiguration("use_sim_time", default=True)

    test_bot_path = get_package_share_directory("test_bot") ##ALTERAR AQUI O NOME DO PACOTE
    world_file = LaunchConfiguration("world_file", default = join(test_bot_path, "worlds", "testing_environment.world.sdf")) ##ALTERAR AQUI O NOME DO ARQUIVO DO MUNDO

    ## ESSES LAUNCH CONFIGURATIONS TALVEZ NÃO PRECISE NO MOMENTO
    ...
    #                 ['xacro ', join(bcr_bot_path, 'urdf/bcr_bot.xacro'), ##ALTERAR O XACRO DO [ROBO]?
    ...
    gz_spawn_entity = Node(
        ...
        arguments=[
            ...
            "-name", "test_bot", ##ALTERAR NOME DO PROJETO
            "-allow_renaming", "true",
            "-z", "0.28",
        ]
    )
    ...
    gz_ros2_bridge = Node(
        ...
        # arguments=[ ## SUBSTITUIR PELO O QUE AQUI?
        ...
        # ],
        # remappings=[ ##ALTERAR AQUI DE ACORDO COM A ESTRUTURA DO PROJETO
    ...
    transform_publisher = Node(
        ...
        arguments = ["--x", "0.0",
                    ...
                    # "--child-frame-id", "bcr_bot/base_link/kinect_camera" ## ALTERAR CAMINHO AQUI DE ACORDO COM A ESTRUTURA DO PROJETO
                    ] 
    )

    ##ALTERAR DE ACORDO COM AS COISAS DEFINIDAS ACIMA
