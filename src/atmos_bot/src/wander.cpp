...
class Wander : public rclcpp::Node{
    public: 
        Wander() : Node("wander"){ 
            action_server_ = rclcpp_action::create_server<atmos_bot::action::Wander>(
                this, 
                "wandering",
    ...
    private:
        ...
        rclcpp_action::GoalResponse handle_goal(
            ...
            std::shared_ptr<const atmos_bot::action::Wander::Goal> goal) {
            return rclcpp_action::GoalResponse::ACCEPT_AND_EXECUTE;
        }

        rclcpp_action::CancelResponse handle_cancel(
            const std::shared_ptr<rclcpp_action::ServerGoalHandle<atmos_bot::action::Wander>> goal_handle) {
            start_wandering_=false;
        ...
        rclcpp_action::Server<atmos_bot::action::Wander>::SharedPtr action_server_;
